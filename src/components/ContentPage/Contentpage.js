  ...
  return (
    <div>
      <div className='content-image-page-data'>
        <img src={imagedata} alt='Content Image' />
      </div>
      <div className='container' style={{ marginTop: '20px' }}>
        <div className='row'>
          ...
          <div className='col-md-6 col-lg-6 col-sm-6'>
            <div className='content-imagesecoundimage'>
              <img src={image2contentdata} alt='Content Image 2' />
            </div>
          </div>
        </div>
        <div className='row'>
          <div className='col-md-6 col-lg-6 col-sm-6'>
            <div className='content-imagesecoundimage'>
              <img src={image2content2} alt='Content Image 3' />
            </div>
          </div>
          <div className='col-md-6 col-lg-6 col-sm-6'>
            <div>
        ...
        <div className='row'>
          ...
          <div className='col-md-6 col-lg-6 col-sm-6'>
            <div className='content-imagesecoundimage'>
              <img src={imagedolllast} alt='Content Image 4' />
            </div>
          </div>
        </div>
      </div>
