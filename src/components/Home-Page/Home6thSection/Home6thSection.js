      ...
      <div className="container" style={{ padding: "10px" }}>
        <div className="row">
          <div className="col-lg-6 col-md-6 col-sm-12">
            <div className="top-image-with-image-data">
          ...
          <div className="col-lg-6 col-md-6 col-sm-12">
            <div className="image-home-dev-space-data-scrolling">
              ...
              <div className="home-last-dev-section-dev-trreing">
                <span>
                  {t(
                    "Lorem Ipsum is a term for completely meaningless text - sometimes also called demi text or gibberish - and is intended to be placed in design sketches - of brochures, magazines, ads, websites, etc. - instead of the final real text - until there is real text. Why not put it in?"
                  )}
                </span>
              </div>
              <div className="subscribe-button-header-home-page-section-last">
                <button>{t("subscribe-purchase")}</button>
              </div>
            </div>
            <div className="image-home-dev-space-data-scrolling">
              <div className="backgroung-image-dat-setin-glasses">
                <div className="image-container-glassespdata">
                  <img src={wineimage1} className="wine-image" alt="Wine 1" />
                  <img src={wineimage2} className="wine-image" alt="Wine 2" />
                </div>
              </div>
            </div>
          </div>
