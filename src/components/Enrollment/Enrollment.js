...
const Enrollment = () => {
      ...
      <ul className="">
        ...
        <div className="font-icon-social-icon1">
          ...
          <div className="col-md-9">
            <h5 style={{textAlign:'end'}}>{t('..the site that works for you even when you are asleep')}</h5>
            <div></div>
            <form>
              <div className="row">
                <div className="col-md-1">
                ...
                <div className="col-md-2">
                  <div className="mb-3">
                    <div>
                     <lable>{t('Job')}</lable> 
                    <button className="dve-button2-enrollment">{t('an employee')}</button>
                    </div>
              ...
              <div className="row">
                <div className="col-md-1">
                  <div className="mb-3">    
                    ...
                    <button className="dve-button2-enrollment">{t('Female')}</button>
                  </div>
                </div>
                <div className="col-md-2">
                  <div className="mb-3">
  ...
  <div className="position-relative">
   <div> <span className="badge position-absolute top-0 start-0" style={{marginTop: '15px',backgroundColor:'transparent'}}>{t('Sex')}</span></div>
    <button className="dve-button-enrollment">{t('Male')}</button>
  </div>
</div>
        ...
        />
              ...
              <div className="row">
                <div className="col-md-2">
                  <div className="mb-3">
                    <button className="dve-button-nav-button">{t('enrollment')}</button>
                  </div>
                </div>
                ...
                <div className="col-md-4">
                  <div className="mb-3">
                    <div className="checkbox-enrollment">
                      ...
                      >
                        {t('Please confirm that you agree to our privacy policy')}{' '}
                      </label>
                      <input
